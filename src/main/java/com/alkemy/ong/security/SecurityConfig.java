...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.cors().and().csrf().disable().authorizeRequests()
				...
				.antMatchers(HttpMethod.GET, "/organization/public").hasAnyRole("USER").and().authorizeRequests()
				.antMatchers(HttpMethod.POST, "/organization/public").hasAnyRole("ADMIN").and().authorizeRequests()
